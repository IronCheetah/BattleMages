...
key_jump_held = keyboard_check(vk_space) || (gamepad_button_check(1, gp_face1));
key_guard = mouse_check_button(mb_right) || gamepad_button_check(1, gp_face2);
key_special = mouse_check_button(mb_left) || gamepad_button_check(1, gp_face4);
key_melee = keyboard_check(ord("E")) || gamepad_button_check(1, gp_face3);
...
if ((grounded) && global.player2_class == 0)
{
	jumps = 2;
}
...
if (vsp < 0)&& (!key_jump_held) && ((!key_guard = 1) && global.player2_class == 0) vsp = max(vsp,-jumpspeed/4)
...
//Death
	...
	//Remove Body and Trigger Respawn
